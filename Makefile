#############################################################################
# Makefile for building: kmldecoder
# Generated by qmake (3.1) (Qt 5.15.2)
# Project:  kmldecoder.pro
# Template: app
# Command: /home/userti/Qt/5.15.2/gcc_64/bin/qmake -o Makefile kmldecoder.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
#############################################################################
...
INCPATH       = -I. -I../../Qt/5.15.2/gcc_64/include -I../../Qt/5.15.2/gcc_64/include/QtXml -I../../Qt/5.15.2/gcc_64/include/QtCore -I. -I../../Qt/5.15.2/gcc_64/mkspecs/linux-g++
QMAKE         = /home/userti/Qt/5.15.2/gcc_64/bin/qmake
DEL_FILE      = rm -f
...
INSTALL_DIR   = cp -f -R
QINSTALL      = /home/userti/Qt/5.15.2/gcc_64/bin/qmake -install qinstall
QINSTALL_PROGRAM = /home/userti/Qt/5.15.2/gcc_64/bin/qmake -install qinstall -exe
DEL_FILE      = rm -f
SYMLINK       = ln -f -s
DEL_DIR       = rmdir
MOVE          = mv -f
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = kmldecoder1.0.0
DISTDIR = /home/userti/Repos\ QT/kmldecoder/.tmp/kmldecoder1.0.0
LINK          = g++
LFLAGS        = -Wl,-rpath,/home/userti/Qt/5.15.2/gcc_64/lib
LIBS          = $(SUBLIBS) /home/userti/Qt/5.15.2/gcc_64/lib/libQt5Xml.so /home/userti/Qt/5.15.2/gcc_64/lib/libQt5Core.so -lpthread   
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		...
		../../Qt/5.15.2/gcc_64/mkspecs/features/cmdline.prf \
		...
		kmldecoder.pro  main.cpp
QMAKE_TARGET  = kmldecoder
DESTDIR       = 
TARGET        = kmldecoder
...
Makefile: kmldecoder.pro ../../Qt/5.15.2/gcc_64/mkspecs/linux-g++/qmake.conf ../../Qt/5.15.2/gcc_64/mkspecs/features/spec_pre.prf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/unix.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/linux.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/sanitize.conf \
		../../Qt/5.15.2/gcc_64/mkspecs/common/gcc-base.conf \
		...
		../../Qt/5.15.2/gcc_64/mkspecs/features/lex.prf \
		kmldecoder.pro
	$(QMAKE) -o Makefile kmldecoder.pro -spec linux-g++ CONFIG+=debug CONFIG+=qml_debug
...
main.o: main.cpp ../../Qt/5.15.2/gcc_64/include/QtCore/QCoreApplication \
		...
		../../Qt/5.15.2/gcc_64/include/QtXml/QDomDocument \
		...
		../../Qt/5.15.2/gcc_64/include/QtXml/QDomElement \
		../../Qt/5.15.2/gcc_64/include/QtXml/QDomNodeList
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

####### Install

install_target: first FORCE
	@test -d $(INSTALL_ROOT)/opt/kmldecoder/bin || mkdir -p $(INSTALL_ROOT)/opt/kmldecoder/bin
	$(QINSTALL_PROGRAM) $(QMAKE_TARGET) $(INSTALL_ROOT)/opt/kmldecoder/bin/$(QMAKE_TARGET)

uninstall_target: FORCE
	-$(DEL_FILE) $(INSTALL_ROOT)/opt/kmldecoder/bin/$(QMAKE_TARGET)
	-$(DEL_DIR) $(INSTALL_ROOT)/opt/kmldecoder/bin/ 
